...
if(!isset($_GET['triwulan'])){
    ...
    echo "<script>location.href='polda.php?triwulan=$triwulan';</script>";
}
?>
            ...
            <div class="card">
                <div class="card-header d-inline-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center justify-content-start">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <select
                                ...
                                if (isset($_GET['periode'])) {
                                    ...
                                    $queryProgram = "SELECT DISTINCT program.id, program.nama_program
                                                    FROM program
                                                    JOIN verifikasi_polda ON verifikasi_polda.program = program.id
                                                    WHERE DATE_FORMAT(verifikasi_polda.Periode, '%Y-%m-%d') = '$selectedPeriode'
                            ...
                            <select
                                ...
                                if (isset($_GET['program'])) {
                                    ...
                                    $queryGiat = "SELECT DISTINCT giat.id, giat.nama_giat
                                                FROM giat 
                                                JOIN verifikasi_polda  ON verifikasi_polda.giat = giat.id
                                                WHERE verifikasi_polda.program = '$selectedProgram'
                            ...
                            <a href="<?= $main_url ?>laporan/polda/polda.php" class="btn btn-sm btn-primary">Reset</a>
                        </div>
                    </div>
                    ...
                    <div class="">
                        ...
                        <?php if (userLogin()['role'] == 1) { ?>
                            <!-- fitur filter select -->
                            <a href="<?= $main_url ?>laporan/polda/filter/batasan.php"
                ...
                <div class="card-body">
                    <table class="display" id="exampleNoSetting">
                        ...
                        <tbody>
                            <?php
                            // Ambil data Max, Min, Max_upload, dan Min_upload dari tabel verifikasi_polda
                            $queryData = "SELECT Min, Max, Min_upload, Max_upload FROM verifikasi_polda";
                            ...
                            $query = "SELECT Polda, Polda, SUM(Sudah_diupload) AS Total_diupload, SUM(Sudah_diverifikasi) AS Total_diverifikasi, 
  ...
  WHERE 1=1";
                            ...
                            $queryPersentase = mysqli_query($koneksi, $query);
                              ...
                              if(!empty($giat)){
                                  ...
                                  $queryMinMax = "SELECT min, max, min_file, max_file FROM batasan WHERE satuan = 'Polda' AND nama = '$programChar'";
                                  ...
                                  $queryMinMax = "SELECT min, max, min_file, max_file FROM batasan WHERE satuan = 'Polda' AND nama = 'Triwulan $triwulan'";
                                  $minMaxRes = mysqli_query($koneksi, $queryMinMax);
                                  $minMax = mysqli_fetch_array($minMaxRes);
                                  // handle error null 
                            ...
                            // Proses data untuk setiap Polda
                            $no = 1;
