...
$title = "Tambah Batasan - Sistem Evaluasi Polda";
...
<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid px-4">
      <h1 class="mt-4">Tambah Batasan</h1>
      <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
        <li class="breadcrumb-item"><a href="<?= $main_url ?>verifikasi/polda/batasan.php">Data Batasan</a></li>
        <li class="breadcrumb-item active">Tambah Batasan</li>
      </ol>
      <form action="proses_tambah_batasan.php" method="POST">
        <div class="card">
          <div class="card-header">
            <span class="h5 my-2"><i class="fa-regular fa-square-plus"></i> Form Tambah Batasan</span>
