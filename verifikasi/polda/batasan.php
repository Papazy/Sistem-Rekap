...
<div id="layoutSidenav_content">
  <main>
    ...
    <div class="container-fluid px-4">
      <h1 class="mt-4">Indikator Batasan</h1>
      ...
      <div class="card">
        <div class="card-header d-inline-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center justify-content-start">
            <span class="h5 my-2 d-flex align-items-center " style="width: 150px;"><i class="fa-solid fa-list me-2"></i> Polda</span>
          ...
          <div class="">
            ...
            <?php if (userLogin()['role'] == 1) { ?>
              <a href="<?= $main_url ?>verifikasi/polda/add_batasan.php"
