...
<html lang="en">
    <head>
        ...
        <title>Login - Sistem Evaluasi Polres</title>
        <!-- <link href="<?= $main_url ?>asset/sb-admin/css/styles.css" rel="stylesheet" /> -->
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" />
        <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
        <link rel="icon" type="image/x-icon" href="<?= $main_url ?>asset/image/bidtik.png">
    </head>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Sistem <img src="../asset/image/bidtik.png" alt="bidtik polda" width="70px" height="70px">  Evaluasi</h3></div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="text-muted small">Copyright &copy; Sistem Evaluasi Polres <?= date("Y") ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
